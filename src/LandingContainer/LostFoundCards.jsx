                ...
                <Modal 
                      ...
                      <div className='flex flex-col justify-start items-left text-left py-3 px-3'>
                          <div className='flex justify-between'>
                            <p className='text-[#155e59] text-2xl font-bold tracking-tight'> {laf.petName} </p> 
                            <div className='flex'>
                            ...
                            <p className='text-[#d95858] text-base tracking-tight pt-2'> Found or Reported by: {laf.reporterName} </p> 
